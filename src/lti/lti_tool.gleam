...
pub fn validate_oidc_login(
  ...
  use _issuer <- result.try(validate_issuer(params))
  use login_hint <- result.try(validate_login_hint(params))
  use registration <- result.try(result.replace_error(
    validate_registration(params),
    "Invalid registration",
  ))
  use client_id <- result.try(validate_client_id(params))
...
fn validate_issuer(params: Dict(String, String)) -> Result(String, String) {
...
fn validate_login_hint(params: Dict(String, String)) -> Result(String, String) {
...
fn validate_client_id(params: Dict(String, String)) -> Result(String, String) {
